  ...
  return (
    <section id="contact" className="container max-w-6xl w-11/12 px-4 py-3 mx-auto my-16">
        ...
        <section className="flex gap-2 flex-wrap">
            <section className="flex-grow basis-96 bg-slate-800 rounded-md p-4 text-slate-300">
                <header className="flex items-center gap-2 mb-4">
                    <i className="bx bxs-chat text-xl text-blue-800"></i>
                    <h1>Live Chat</h1>
                </header>
                <section className="bg-slate-700 rounded-md p-3 flex flex-col max-h-96 overflow-auto mb-2">
                ...
                <section className="bg-slate-700 rounded-md p-3 flex items-center gap-2">
                    <input type="text" value={chat} className="w-full bg-slate-800 rounded-md p-2" onChange={handleChat} />
                    <button className={`h-10 w-10 flex items-center justify-center rounded-md shadow transition shadow-blue-950 hover:bg-blue-900 disabled:bg-slate-800 disabled:cursor-default`} disabled={disable}><i className="bx bx-send text-xl"></i></button>
                </section>
            </section>
            <motion.div ref={constraintsRef} className="flex-grow basis-36 flex justify-center items-center bg-slate-800 rounded-md h-96 lg:h-auto relative ">
                <motion.div
                    drag
